...
#     _fields_ = [
#         ("ip", c_ubyte * 4),  # Assuming IP is stored as 4 bytes
#         ("port", c_uint16),   # Assuming port is stored as an unsigned short
#         ("lead", c_float*3),    # Lead
#         # ("microstepping", c_int32)  # Microstepping
#         ("subdivision", c_int32)  # Microstepping
#         # Add more fields here if there are more parameters
#     ]
...
class MotorSystem:
    ...
    def move(self, axis, distance_mm, dir, speed, callback=None):
        ...
        # it seems the hardware used 0.1 mm as unit
    ...
    def get_current_position(self, axis):
        ...
        if result == 0:
            # it seems the hardware used 0.1 mm as unit
            # this will make the distance correct in mm
